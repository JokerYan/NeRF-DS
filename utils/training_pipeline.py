...
training_schedule = [
  ("z-vrig-broom-new", "z-vrig-broom-new", "re_ms", "exp47"),
  ...
  # ("z-vrig-3dprinter", "z-vrig-3dprinter", "base", "exp45"),  # GPU3
  # ("z-vrig-broom", "z-vrig-broom", "base", "exp45"),          # GPU3
  # ("z-vrig-chicken", "z-vrig-chicken", "base", "exp45"),
  # ("z-vrig-peel-banana", "z-vrig-peel-banana", "base", "exp45"),

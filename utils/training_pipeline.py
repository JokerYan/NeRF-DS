...
training_schedule = [
  ...
  #                                                          "NerfModel.use_predicted_mask = True"]),
  # ("011_bell_07_novel_view", "011_b07_nv_ms_exp09", "ms", ["ExperimentConfig.image_scale = 1",
  #                                                          "NerfModel.use_predicted_mask = True",
  #                                                          "NerfModel.use_coarse_depth_for_mask = True"]),
  # ("011_bell_07_novel_view", "011_b07_nv_ms_exp10", "ms", ["ExperimentConfig.image_scale = 1",
  #                                                          "SpecularConfig.use_shrinkage_loss = True"]),
  # ("011_bell_07_novel_view", "011_b07_nv_ms_exp11", "ms", ["ExperimentConfig.image_scale = 1",
  #                                                          "NerfModel.use_predicted_mask = True",
  #                                                          "NerfModel.use_coarse_depth_for_mask = True"]),

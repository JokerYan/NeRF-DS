...
training_schedule = [
  ...
  ("012_cup_01_novel_view", "012_c01_nv_ms_exp17", "ms", ["ExperimentConfig.image_scale = 1",
                                                            "NerfModel.use_predicted_mask = True",
                                                            "NerfModel.use_coarse_depth_for_mask = True",
                                                            "SpecularConfig.mask_ratio_schedule = {'type': 'constant', 'value': 1}",
                                                            "NerfModel.use_x_in_rgb_condition = True"]),
  ...
  ("013_bowl_01_novel_view", "013_bo01_nv_ms_exp19", "ms", ["ExperimentConfig.image_scale = 1",
                                                            "NerfModel.use_predicted_mask = True",
                                                            "NerfModel.use_coarse_depth_for_mask = True",
                                                            "SpecularConfig.mask_ratio_schedule = {'type': 'constant', 'value': 1}",
                                                            "NerfModel.use_x_in_rgb_condition = True",
